    ...
    <main className="min-h-screen pb-24">
      ...
      <div className="px-6 pt-6">
        ...
        >
          {/* Blob Avatar */}
          <div className="relative w-48 h-48 mb-2">
            <div className="absolute inset-0 bg-[#1A1A3A] rounded-[60%_40%_30%_70%_/_50%_60%_40%_50%] animate-[blob_8s_ease-in-out_infinite] scale-110" />
            <div className="absolute inset-0 bg-[#2A2A5A] rounded-[40%_60%_70%_30%_/_40%_50%_60%_50%] animate-[blob_8s_ease-in-out_infinite_reverse] scale-105" />
            <div className="relative w-full h-full rounded-[50%_50%_40%_60%_/_60%_40%_50%_50%] overflow-hidden border-2 border-blue-400/20 z-10 flex items-center justify-center bg-gradient-to-br from-purple-500 to-blue-500">
               <span className="text-white text-5xl font-bold">B7</span>
            </div>
          </div>

          <div className="flex items-center justify-center gap-2 mb-2">
            <h2 className="text-2xl font-bold text-white">./B7</h2>
            <CheckCircle2 className="w-6 h-6 text-blue-500 fill-blue-500/20" />
          </div>
